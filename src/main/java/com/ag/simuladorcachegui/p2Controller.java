...
public class p2Controller extends MainController {
    ...
    private void voltarMenuL() throws IOException {
        mudarTela("/com/ag/simuladorcachegui/menu.fxml", buttonVoltarLPane, "/processador2.css");
    }
    ...
    private void realizarLeitura() {
        ...
        if (inputDadoLido.getText().isEmpty() || !Pattern.matches("^[0-9]*$", inputDadoLido.getText())) {
            ...
            Integer enderecobloco2 = gerenciador.getProcessador("Processador2").confereDadoCache(id);
            if (enderecobloco2 != null) {
                MemoriaCache.blocoCache blocoCache = gerenciador.getProcessador("Processador2").getBlocoCache(enderecobloco2);
                if (blocoCache.getTag() == MemoriaCache.tags.Invalido) {
                    int resultado = MainController.readMissInvalido(ram, gerenciador.getProcessador("Processador2"), gerenciador.getProcessador("Processador1"), gerenciador.getProcessador("Processador3"), id, blocoCache, enderecobloco2);
                    switch (resultado) {
                        case 0:
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            System.out.println("Ocorreu um erro, conferir a função e o resultado " + resultado);
                            break;
                    }
                } else {
                    int indiceBloco = readHit(gerenciador.getProcessador("Processador2"), id);
                    relatorioTextAreaL.setText("""
                            Simulador-Cache Log:
                            ...
                            """
                            +
                            gerenciador.getProcessador("Processador2").getMemoriaCache().printPosicaoCache(indiceBloco)
                            +
                            """
                ...
                int resultadoRM = readMiss(ram, gerenciador.getProcessador("Processador2"), gerenciador.getProcessador("Processador1"), gerenciador.getProcessador("Processador3"), id);
                switch (resultadoRM) {
                    case 0:
                    ...
                    case 5:
                        ...
                        break;
                    default:
                        System.out.println("Ocorreu um erro, por favor conferir função e resultado" + resultadoRM);
                        break;
                }
            }
        }
    ...
    private void realizarEscrita() {
        ...
        if( inputDadoE.getText().isEmpty() ||
            ...
            Integer enderecobloco = gerenciador.getProcessador("Processador2").confereDadoCache(id);
            int dadoEscrita = Integer.parseInt(inputDadoEscrita.getText());
            if(enderecobloco != null) {
                MemoriaCache.blocoCache blocoCache = gerenciador.getProcessador("Processador2").getBlocoCache(enderecobloco);
                if(blocoCache.getTag() == MemoriaCache.tags.Invalido) {
                    int res = writeMissInvalido(ram, gerenciador.getProcessador("Processador2"), gerenciador.getProcessador("Processador1"), gerenciador.getProcessador("Processador3"), id, blocoCache, enderecobloco, dadoEscrita);
                    switch (res){
                        case 0:
                        ...
                        case 2:
                            ...
                            break;
                        default:
                            System.out.println("Ocorreu um erro, por favor conferir função e resultado " + res);
                            break;
                    }
                } else {
                    int res = writeHit(dadoEscrita, id, enderecobloco, ram, gerenciador.getProcessador("Processador2"), gerenciador.getProcessador("Processador1"), gerenciador.getProcessador("Processador3"));
                    switch (res) {
                        case 0:
                            relatorioTextAreaE.setText("""
                                    Simulador-Cache Log:
                ...
                int res = writeMiss(ram, gerenciador.getProcessador("Processador2"), gerenciador.getProcessador("Processador1"), gerenciador.getProcessador("Processador3"), id, dadoEscrita);
                switch (res) {
                    case 0:
                        relatorioTextAreaE.setText("""
                                    Simulador-Cache Log:
